...
tilt = pygame.image.load('bally_entry/assets/tilt.png').convert_alpha()
feature = pygame.image.load('bally_entry/assets/feature.png').convert_alpha()
left = pygame.image.load('bally_entry/assets/left.png').convert_alpha()
odds = pygame.image.load('bally_entry/assets/odds.png').convert_alpha()
type_image = pygame.image.load('bally_entry/assets/type.png').convert_alpha()
letter_e = pygame.image.load('bally_entry/assets/letter_e.png').convert_alpha()
letter_n = pygame.image.load('bally_entry/assets/letter_n.png').convert_alpha()
letter_t = pygame.image.load('bally_entry/assets/letter_t.png').convert_alpha()
letter_r = pygame.image.load('bally_entry/assets/letter_r.png').convert_alpha()
letter_y = pygame.image.load('bally_entry/assets/letter_y.png').convert_alpha()
selection = pygame.image.load('bally_entry/assets/selection.png').convert_alpha()
bg_menu = pygame.image.load('bally_entry/assets/backglass_menu.png').convert_alpha()
bg_gi = pygame.image.load('bally_entry/assets/backglass_gi.png').convert_alpha()
bg_off = pygame.image.load('bally_entry/assets/backglass_off.png').convert_alpha()
