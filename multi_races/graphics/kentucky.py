...
tilt = pygame.image.load('kentucky/assets/tilt.png').convert_alpha()
arrow = pygame.image.load('kentucky/assets/arrow.png').convert_alpha()
feature = pygame.image.load('kentucky/assets/feature.png').convert_alpha()
horseshoe = pygame.image.load('kentucky/assets/horseshoe.png').convert_alpha()
odds = pygame.image.load('kentucky/assets/odds.png').convert_alpha()
place = pygame.image.load('kentucky/assets/place.png').convert_alpha()
purse = pygame.image.load('kentucky/assets/purse.png').convert_alpha()
scores_double = pygame.image.load('kentucky/assets/scores_double.png').convert_alpha()
scores_win = pygame.image.load('kentucky/assets/scores_win.png').convert_alpha()
section = pygame.image.load('kentucky/assets/section.png').convert_alpha()
selection = pygame.image.load('kentucky/assets/selection.png').convert_alpha()
show = pygame.image.load('kentucky/assets/show.png').convert_alpha()
trophy = pygame.image.load('kentucky/assets/trophy.png').convert_alpha()
wild = pygame.image.load('kentucky/assets/wild.png').convert_alpha()
win = pygame.image.load('kentucky/assets/win.png').convert_alpha()
bg_menu = pygame.image.load('kentucky/assets/backglass_menu.png').convert_alpha()
bg_gi = pygame.image.load('kentucky/assets/backglass_gi.png').convert_alpha()
bg_off = pygame.image.load('kentucky/assets/backglass_off.png').convert_alpha()
