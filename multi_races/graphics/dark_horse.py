...
tilt = pygame.image.load('dark_horse/assets/tilt.png').convert_alpha()
feature = pygame.image.load('dark_horse/assets/feature.png').convert_alpha()
multiplier = pygame.image.load('dark_horse/assets/multiplier.png').convert_alpha()
odds = pygame.image.load('dark_horse/assets/odds.png').convert_alpha()
selection = pygame.image.load('dark_horse/assets/selection.png').convert_alpha()
selection2 = pygame.image.load('dark_horse/assets/selection2.png').convert_alpha()
bg_menu = pygame.image.load('dark_horse/assets/backglass_menu.png').convert_alpha()
bg_gi = pygame.image.load('dark_horse/assets/backglass_gi.png').convert_alpha()
bg_off = pygame.image.load('dark_horse/assets/backglass_off.png').convert_alpha()
